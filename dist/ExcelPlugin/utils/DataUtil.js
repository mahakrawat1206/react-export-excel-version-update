...
var strToArrBuffer = exports.strToArrBuffer = function strToArrBuffer(s) {
...
var dateToNumber = exports.dateToNumber = function dateToNumber(v, date1904) {
  if (date1904) {
    v += 1462;
  }
...
var excelSheetFromDataSet = exports.excelSheetFromDataSet = function excelSheetFromDataSet(dataSet) {
  /*
...
var excelSheetFromAoA = exports.excelSheetFromAoA = function excelSheetFromAoA(data) {
  var ws = {};
  var range = {
    s: {
      c: 10000000,
